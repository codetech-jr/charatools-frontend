 ...
 *
 * - Aparece en todas las páginas via root layout.
 * - Posicionado bottom-right, encima del QuotationDrawer trigger.
 * - Pulso animado para captar atención (solo en móvil — no distrae en desktop).
 * - Se oculta cuando el QuotationDrawer está abierto para evitar solapamiento.
...
const WA_URL =
  ...
  encodeURIComponent('Hola CharaTools, necesito ayuda con un producto.')
